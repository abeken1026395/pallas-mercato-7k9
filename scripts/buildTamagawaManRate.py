# -*- coding: utf-8 -*-
"""
多摩川払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/tamagawaPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/tamagawaManRate.json
...
SRC = os.path.join("docs", "payouts", "tamagawaPayouts.csv")
OUT = os.path.join("docs", "payouts", "tamagawaManRate.json")
