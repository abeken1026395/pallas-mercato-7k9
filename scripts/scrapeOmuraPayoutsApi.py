# -*- coding: utf-8 -*-
"""
大村（jcd=24）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/omuraPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/omuraPayouts.csv"
...
def extract_omura(doc):
    """大村(24)の各レースから 3連単組番と配当を取り出す。"""
    out = []
