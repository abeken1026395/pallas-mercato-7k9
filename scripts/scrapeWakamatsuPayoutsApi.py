# -*- coding: utf-8 -*-
"""
若松（jcd=20）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/wakamatsuPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/wakamatsuPayouts.csv"
...
def extract_wakamatsu(doc):
    """若松(20)の各レースから 3連単組番と配当を取り出す。"""
    out = []
