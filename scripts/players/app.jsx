...
function emRatio(t){
  ...
  b.type="button"; b.setAttribute("aria-label",d("6ZaJ44GY44KL")); b.textContent="\u00d7";
  ...
  b.addEventListener("click",function(){w.parentNode.removeChild(w);});
  w.appendChild(p); w.appendChild(a); w.appendChild(b);
