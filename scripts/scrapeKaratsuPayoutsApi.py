# -*- coding: utf-8 -*-
"""
唐津（jcd=23）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/karatsuPayouts.csv （列: hd, rno, combo, payout）
...
def extract_karatsu(doc):
    """唐津(23)の各レースから 3連単組番と配当を取り出す。"""
    out = []
