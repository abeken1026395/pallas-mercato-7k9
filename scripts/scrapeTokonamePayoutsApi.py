# -*- coding: utf-8 -*-
"""
常滑（jcd=8）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/tokonamePayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/tokonamePayouts.csv"
...
def extract_tokoname(doc):
    """常滑(8)の各レースから 3連単組番と配当を取り出す。"""
    out = []
