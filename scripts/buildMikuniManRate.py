# -*- coding: utf-8 -*-
"""
三国払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/mikuniPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/mikuniManRate.json
...
SRC = os.path.join("docs", "payouts", "mikuniPayouts.csv")
OUT = os.path.join("docs", "payouts", "mikuniManRate.json")
