# -*- coding: utf-8 -*-
"""
福岡（jcd=22）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/fukuokaPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/fukuokaPayouts.csv"
...
def extract_fukuoka(doc):
    """福岡(22)の各レースから 3連単組番と配当を取り出す。"""
    out = []
