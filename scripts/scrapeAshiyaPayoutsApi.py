# -*- coding: utf-8 -*-
"""
芦屋（jcd=21）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/ashiyaPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/ashiyaPayouts.csv"
...
def extract_ashiya(doc):
    """芦屋(21)の各レースから 3連単組番と配当を取り出す。"""
    out = []
