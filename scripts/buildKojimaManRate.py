# -*- coding: utf-8 -*-
"""
児島払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/kojimaPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/kojimaManRate.json
...
SRC = os.path.join("docs", "payouts", "kojimaPayouts.csv")
OUT = os.path.join("docs", "payouts", "kojimaManRate.json")
