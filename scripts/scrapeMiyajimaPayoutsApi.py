# -*- coding: utf-8 -*-
"""
宮島（jcd=17）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/miyajimaPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/miyajimaPayouts.csv"
...
def extract_miyajima(doc):
    """宮島(17)の各レースから 3連単組番と配当を取り出す。"""
    out = []
