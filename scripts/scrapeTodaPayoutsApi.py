# -*- coding: utf-8 -*-
"""
戸田（jcd=2）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/todaPayouts.csv （列: hd, rno, combo, payout）
...
def extract_toda(doc):
    """戸田(2)の各レースから 3連単組番と配当を取り出す。"""
    out = []
