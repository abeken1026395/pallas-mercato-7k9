# -*- coding: utf-8 -*-
"""
住之江払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/suminoePayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/suminoeManRate.json
...
SRC = os.path.join("docs", "payouts", "suminoePayouts.csv")
OUT = os.path.join("docs", "payouts", "suminoeManRate.json")
