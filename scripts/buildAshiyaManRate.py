# -*- coding: utf-8 -*-
"""
芦屋払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/ashiyaPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/ashiyaManRate.json
...
SRC = os.path.join("docs", "payouts", "ashiyaPayouts.csv")
OUT = os.path.join("docs", "payouts", "ashiyaManRate.json")
