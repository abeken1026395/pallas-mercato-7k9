# -*- coding: utf-8 -*-
"""
丸亀（jcd=15）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/marugamePayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/marugamePayouts.csv"
...
def extract_marugame(doc):
    """丸亀(15)の各レースから 3連単組番と配当を取り出す。"""
    out = []
