# -*- coding: utf-8 -*-
"""
平和島（jcd=4）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/heiwajimaPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/heiwajimaPayouts.csv"
...
def extract_heiwajima(doc):
    """平和島(4)の各レースから 3連単組番と配当を取り出す。"""
    out = []
