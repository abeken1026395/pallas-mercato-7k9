# -*- coding: utf-8 -*-
"""
びわこ（jcd=11）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/biwakoPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/biwakoPayouts.csv"
...
def extract_biwako(doc):
    """びわこ(11)の各レースから 3連単組番と配当を取り出す。"""
    out = []
