# -*- coding: utf-8 -*-
"""
びわこ払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/biwakoPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/biwakoManRate.json
...
SRC = os.path.join("docs", "payouts", "biwakoPayouts.csv")
OUT = os.path.join("docs", "payouts", "biwakoManRate.json")
