# -*- coding: utf-8 -*-
"""
大村払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/omuraPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/omuraManRate.json
...
SRC = os.path.join("docs", "payouts", "omuraPayouts.csv")
OUT = os.path.join("docs", "payouts", "omuraManRate.json")
