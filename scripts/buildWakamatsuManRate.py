# -*- coding: utf-8 -*-
"""
若松払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/wakamatsuPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/wakamatsuManRate.json
...
SRC = os.path.join("docs", "payouts", "wakamatsuPayouts.csv")
OUT = os.path.join("docs", "payouts", "wakamatsuManRate.json")
