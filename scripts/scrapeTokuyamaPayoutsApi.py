# -*- coding: utf-8 -*-
"""
徳山（jcd=18）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/tokuyamaPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/tokuyamaPayouts.csv"
...
def extract_tokuyama(doc):
    """徳山(18)の各レースから 3連単組番と配当を取り出す。"""
    out = []
