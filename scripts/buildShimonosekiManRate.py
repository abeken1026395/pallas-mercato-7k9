# -*- coding: utf-8 -*-
"""
下関払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/shimonosekiPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/shimonosekiManRate.json
...
SRC = os.path.join("docs", "payouts", "shimonosekiPayouts.csv")
OUT = os.path.join("docs", "payouts", "shimonosekiManRate.json")
