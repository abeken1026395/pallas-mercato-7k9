# -*- coding: utf-8 -*-
"""
鳴門（jcd=14）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/narutoPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/narutoPayouts.csv"
...
def extract_naruto(doc):
    """鳴門(14)の各レースから 3連単組番と配当を取り出す。"""
    out = []
