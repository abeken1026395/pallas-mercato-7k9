# -*- coding: utf-8 -*-
"""
三国（jcd=10）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/mikuniPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/mikuniPayouts.csv"
...
def extract_mikuni(doc):
    """三国(10)の各レースから 3連単組番と配当を取り出す。"""
    out = []
