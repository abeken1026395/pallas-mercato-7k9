# -*- coding: utf-8 -*-
"""
戸田払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/todaPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/todaManRate.json
...
SRC = os.path.join("docs", "payouts", "todaPayouts.csv")
OUT = os.path.join("docs", "payouts", "todaManRate.json")
