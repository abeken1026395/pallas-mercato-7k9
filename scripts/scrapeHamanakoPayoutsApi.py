# -*- coding: utf-8 -*-
"""
浜名湖（jcd=6）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/hamanakoPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/hamanakoPayouts.csv"
...
def extract_hamanako(doc):
    """浜名湖(6)の各レースから 3連単組番と配当を取り出す。"""
    out = []
