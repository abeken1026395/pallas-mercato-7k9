# -*- coding: utf-8 -*-
"""
多摩川（jcd=5）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/tamagawaPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/tamagawaPayouts.csv"
...
def extract_tamagawa(doc):
    """多摩川(5)の各レースから 3連単組番と配当を取り出す。"""
    out = []
