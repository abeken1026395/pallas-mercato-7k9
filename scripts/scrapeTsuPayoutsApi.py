# -*- coding: utf-8 -*-
"""
津（jcd=9）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/tsuPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/tsuPayouts.csv"
