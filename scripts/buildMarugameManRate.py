# -*- coding: utf-8 -*-
"""
丸亀払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/marugamePayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/marugameManRate.json
...
SRC = os.path.join("docs", "payouts", "marugamePayouts.csv")
OUT = os.path.join("docs", "payouts", "marugameManRate.json")
