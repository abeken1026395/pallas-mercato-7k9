# -*- coding: utf-8 -*-
"""
尼崎（jcd=13）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/amagasakiPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/amagasakiPayouts.csv"
...
def extract_amagasaki(doc):
    """尼崎(13)の各レースから 3連単組番と配当を取り出す。"""
    out = []
