# -*- coding: utf-8 -*-
"""
福岡払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/fukuokaPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/fukuokaManRate.json
...
SRC = os.path.join("docs", "payouts", "fukuokaPayouts.csv")
OUT = os.path.join("docs", "payouts", "fukuokaManRate.json")
