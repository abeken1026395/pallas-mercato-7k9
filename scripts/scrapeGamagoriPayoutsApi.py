# -*- coding: utf-8 -*-
"""
蒲郡（jcd=7）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/gamagoriPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/gamagoriPayouts.csv"
...
def extract_gamagori(doc):
    """蒲郡(7)の各レースから 3連単組番と配当を取り出す。"""
    out = []
