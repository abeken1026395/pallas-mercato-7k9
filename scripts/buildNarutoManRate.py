# -*- coding: utf-8 -*-
"""
鳴門払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/narutoPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/narutoManRate.json
...
SRC = os.path.join("docs", "payouts", "narutoPayouts.csv")
OUT = os.path.join("docs", "payouts", "narutoManRate.json")
