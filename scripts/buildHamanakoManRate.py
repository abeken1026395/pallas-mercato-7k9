# -*- coding: utf-8 -*-
"""
浜名湖払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/hamanakoPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/hamanakoManRate.json
...
SRC = os.path.join("docs", "payouts", "hamanakoPayouts.csv")
OUT = os.path.join("docs", "payouts", "hamanakoManRate.json")
