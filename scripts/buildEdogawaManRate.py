# -*- coding: utf-8 -*-
"""
江戸川払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/edogawaPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/edogawaManRate.json
...
SRC = os.path.join("docs", "payouts", "edogawaPayouts.csv")
OUT = os.path.join("docs", "payouts", "edogawaManRate.json")
