# -*- coding: utf-8 -*-
"""
平和島払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/heiwajimaPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/heiwajimaManRate.json
...
SRC = os.path.join("docs", "payouts", "heiwajimaPayouts.csv")
OUT = os.path.join("docs", "payouts", "heiwajimaManRate.json")
