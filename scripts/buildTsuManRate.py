# -*- coding: utf-8 -*-
"""
津払戻CSV → R別万舟率JSON集計（桐生・徳山と同一スキーマ）
入力: docs/payouts/tsuPayouts.csv （hd, rno, combo, payout）
出力: docs/payouts/tsuManRate.json
...
SRC = os.path.join("docs", "payouts", "tsuPayouts.csv")
OUT = os.path.join("docs", "payouts", "tsuManRate.json")
