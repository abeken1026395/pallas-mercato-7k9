# -*- coding: utf-8 -*-
"""
江戸川（jcd=3）3連単払戻データ収集（クラウド到達可能ソース版）
...
出力: docs/payouts/edogawaPayouts.csv （列: hd, rno, combo, payout）
...
OUT = "docs/payouts/edogawaPayouts.csv"
...
def extract_edogawa(doc):
    """江戸川(3)の各レースから 3連単組番と配当を取り出す。"""
    out = []
